...
- Install the dependencies first and then run `npm run dev` locally. This should start the app in `http://localhost:3000/`. If the `3000` port is occupied, it'll assign another one and it'll prompt the new address.
